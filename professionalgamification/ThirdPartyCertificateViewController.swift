//
//  ThirdPartyCertificateViewController.swift
...
class ThirdPartyCertificateViewController: UIViewController {
    ...
    @IBAction func submitActivity(_ sender: UIButton) {
        ...
        temp.studentPoints += 20
        appDelegate.Activity.activityName = "Certificate"
