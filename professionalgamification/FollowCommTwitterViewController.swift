//
//  FollowCommTwitterViewController.swift
...
class FollowCommTwitterViewController: UIViewController {
    ...
    @IBAction func submitActivity(_ sender: UIButton) {
        ...
        temp.studentPoints += 5
        appDelegate.Activity.activityName = "FollowCommTwitter"
